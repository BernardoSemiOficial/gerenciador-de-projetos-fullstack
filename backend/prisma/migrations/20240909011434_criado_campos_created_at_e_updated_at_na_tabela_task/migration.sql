...
INSERT INTO "new_tasks" ("delivery_time", "description", "id", "name", "priority_id", "project_id", "public_id", "status_id") SELECT "delivery_time", "description", "id", "name", "priority_id", "project_id", "public_id", "status_id" FROM "tasks";
DROP TABLE "tasks";
